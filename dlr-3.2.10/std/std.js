...
async function loadDylibs() {
    return await new Promise((rs, rj) => {
        ...
        dynamicLibraries.slice(0, 1).reduce(function (chain, lib) {
...
run();
Module['loadDylibs'] = loadDylibs;Module['UTF8ToString'] = UTF8ToString;Module['loadDynamicLibrary'] = loadDynamicLibrary;Module['_malloc'] = _malloc;Module['_free'] = _free;Module['wasmImports'] = wasmImports;
versions.std = { worker: "No Wroker", wasm: "1.2.0" };